...
class PoliceCar implements IsLandVehicle, IsEmergency {
    ...
    // IsEmergency methods
    public void soundSiren() {
        System.out.println("TAA TUU TAA TUU");
    }

    // PoliceCar methods
    public void chase() {
        System.out.println("Chasing thieves like a boss!");
    }
}
...
class InterTest {
   ...
   public static void main(String[] args) {
      ...
      myArray[4] = new PoliceCar("Thief Picker");
      ...
      for (int i=0; i<myArray.length; i++) {
         ...
         if (myArray[i] instanceof IsEmergency) {
            IsEmergency lv = (IsEmergency)myArray[i];
            lv.soundSiren();
         }
